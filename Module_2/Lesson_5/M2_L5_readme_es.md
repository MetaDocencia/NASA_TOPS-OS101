...
[ Protocols.io](https://www.protocols.io/) es una plataforma en línea y segura para las personas que hacen ciencias afiliadas al mundo académico, la industria, organizaciones sin fines de lucro y agencias. Permite a quienes la usan crear, gestionar, intercambiar, mejorar y compartir métodos y protocolos de investigación de distintas disciplinas. Este recurso puede mejorar la colaboración y el mantenimiento de registros, lo que aumenta la productividad de los equipos y facilita la enseñanza, especialmente en las ciencias humanas. En su versión gratuita, protocols.io admite protocolos compartidos públicamente, mientras que los planes pagos permiten compartirlos de forma privada, por ejemplo para la industria.
