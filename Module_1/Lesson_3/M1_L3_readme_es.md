...
- [Mantenimiento de la seguridad y protección de la privacidad](#mantenimiento-de-la-seguridad-y-protección-de-la-privacidad)
- [Propiedad intelectual](#propiedad-intelectual)
- [Políticas y prácticas en torno a la Ciencia Abierta](#políticas-y-prácticas-en-torno-a-la-Ciencia-Abierta)
...
Esta lección explica aspectos importantes de seguridad y privacidad para las personas que hacen ciencia al momento del compartir información. A continuación, la lección explica cómo el intercambio de información puede impactar en diferentes comunidades. A continuación, la lección detalla acerca de la propiedad intelectual, cómo puede protegerse y los distintos tipos de licencias disponibles para facilitar el intercambio, garantizando al mismo tiempo que las personas propietarias de la información reciban el reconocimiento por su trabajo. Por último, se trata el impacto de las normas y reglamentos establecidos por una organización, subvención o editorial sobre las posibilidades que tiene un científico de hacer que su investigación sea de acceso abierto.

## Objetivos del aprendizaje

Después de completar esta lección, deberías ser capaz de:

- Enumerar las razones de por qué no debe compartirse la información por motivos de seguridad o privacidad.
...
En los siguientes párrafos de esta sección se esbozan aspectos clave a tener en cuenta, para determinar si conviene o no, poner sus datos a disposición del público.

## Manteniendo la seguridad y protegiendo la privacidad

Las lecciones anteriores han mostrado una amplia gama de casos de éxito de la ciencia abierta, pero reconocemos que todavía hay muchas preocupaciones válidas y desafíos inexplorados en la aplicación de la ciencia abierta. La ciencia abierta exige la apreciada pero compleja práctica de respetar las diversas culturas, manteniendo la seguridad y protegiendo la privacidad. Esta lección presenta un enfoque estratégico para tomar decisiones sobre la realización de ciencia abierta en escenarios comunes. Para aquellos escenarios que no podemos anticipar, esta lección ofrece estrategias de mitigación, para ayudar a superar dificultades particulares, con una preparación conveniente y el apoyo de la comunidad.

**Escenario: Secretos militares de un país o violación de intereses nacionales**

Cuando la divulgación de datos o investigaciones puede plantear problemas de seguridad nacional, existen restricciones añadidas a la hora de compartir esta información. En Estados Unidos, el intercambio de este tipo de información suele estar sujeto a las normativas de control de exportaciones ITAR (International Traffic in Arms Regulations) y EAR (Export Administration Regulations). Compartir datos, equipos, recursos o investigaciones regulados por el ITAR/EAR sin autorización para ello, puede poner en peligro la seguridad nacional del país y acarrear graves sanciones penales y administrativas.
...
En Estados Unidos, los datos sanitarios están protegidos por la Ley de Portabilidad y Responsabilidad de los Seguros Sanitarios de 1996 (US-HIPAA) y no está permitido compartirlos sin el consentimiento expreso y por escrito del paciente. Por ello, la NASA protege cuidadosamente la información sanitaria de los astronautas, tratando de equilibrar la publicidad del trabajo con la normativa y las mejores prácticas de privacidad médica, al tiempo que permite la investigación biomédica supervisada por expertos.

Vea este ejemplo y otros en [Open Science Data Repository] de la NASA (https://osdr.nasa.gov/bio/repo/data/studies/OSD-530/).

**Respetando la diversidad cultural**

La Ciencia Abierta promueve la divulgación de la investigación, pero también reconoce que hay muchas razones por las que cierta información no debe publicarse, estas decisiones deben tomarse con la participación de las personas que han contribuido a ella o que podrían verse perjudicadas por las consecuencias de su publicación.

**Aspectos indígenas, culturales y de conservación**

Al considerar las repercusiones de la divulgación de datos, es importante reconocer si los afectados están equitativamente representados en el debate. Por ejemplo, las comunidades históricamente excluidas, el medio ambiente, la fauna y flora silvestres no suelen tenerse en cuenta a la hora de decidir si la investigación es de libre acceso.
...
Los [Principios CARE de Soberanía de Datos Indígenas](https://www.gida-global.org/care) están orientados a las personas, los objetivos se establecieron originalmente para utilizar los datos de forma que se fomente la gobernanza de la información y la autodeterminación de los pueblos indígenas. Los principios CARE pueden aplicarse involucrando a las comunidades o grupos locales y deben contemplarse al inicio de un proyecto de investigación.
...
La justicia medioambiental es el trato justo y la participación real de todas las personas, independientemente de su origen, nacionalidad o ingresos, en el desarrollo, aplicación y cumplimiento de las leyes, normativas y políticas medioambientales. Más información sobre cómo [los datos de la NASA sobre la Tierra se hacen más accesibles a las comunidades más afectadas](https://www.earthdata.nasa.gov/learn/backgrounders/environmental-justice).

**Proteger las especies en peligro**

Los humanos no son el único grupo que puede verse afectado negativamente por el intercambio de datos. Las especies raras y amenazadas también pueden verse afectadas. Por [ejemplo](https://www.rspb.org.uk/birds-and-wildlife/crane), el hecho de invadir los lugares de reproducción de las poblaciones silvestres en extinción puede agravar aún más el declive de la población. Por esta razón, los lugares de cría de animales en peligro de extinción de se deben mantener en secreto.
...
Una patente es un derecho exclusivo otorgado para una invención, el cual es un producto o un proceso que proporciona, en general, una nueva forma de hacer algo, u ofrece una nueva solución técnica a un problema. Las patentes son otra forma de hacer que tu trabajo sea abierto mientras proteges tu propiedad intelectual.

Muchas organizaciones cuentan con grupos que apoyarán el desarrollo y la comercialización de invenciones. [La Oficina de Transferencia de Tecnología de la NASA](https://technology.nasa. La oficina ov/) es un ejemplo de ello, ya que pone a disposición de las personas usuarias gran parte de las invenciones de la NASA para la concesión de licencias como parte de la [NASA Patent Portfolio](https://technology.nasa.gov/patents).
...
Si envías tu manuscrito a una editorial que requiere ser la dueña de los derechos de la obra, ¿Podrás acceder a esa publicación cuando cambies de trabajo y ya no tengas una suscripción a esa obra? ¿Puedes cumplir los mandatos de tu organismo de financiación para compartir abiertamente tu trabajo? ¿Puede reutilizar las figuras que has hecho en obras derivadas? ¿Podrán otros acceder a tu trabajo? Aunque parezcan cuestiones por las que no deberías preocuparte, pueden resultar muy difícil afrontarlas luego.
...
Si no licencias tu trabajo, otras personas no pueden o no deberían volver a usarlo- aunque quisieras.

Las licencias se pueden aplicar a datos, código e informes, o publicaciones, y casi cualquier otro producto "creativo". También existen diferentes tipos de licencias y también casos en el que no es necesario solicitar licencia:
...
Coloque las siguientes actividades en las casillas Compartir o No compartir:
...
### Preparando para usar y hacer investigación controlada

Es importante planificar la publicación de sus datos y resultados desde el principio de su proyecto de investigación. Investiga y obtén todos los permisos, aprobaciones y/o certificados necesarios para asegurar que puedas compartir tus productos de investigación.

**Recuerda:** ¡Las revistas y los repositorios reputables rechazarán los envíos si el acatamiento no se puede documentar!
...
<table>
  ...
  <tbody>
    <tr>
        <td colspan="3">
            <ul>
            <li>Compruebe los requisitos específicos del experimento con antelación.</li>
            <li>Asegúrese de cumplir con todos los aspectos de la revisión en curso.</li>
            </ul>
        </td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    <tr>
        <td colspan="3">
            <ul>
            <li>No asuma que la colección está permitida sólo porque una ubicación de muestreo parece no administrada.</li>
            <li>Involúcrate y consulta con las comunidades locales para asegurar que sus preocupaciones sean atendidas.</li>
            </ul>
        </td>
    </tr>
  </tbody>
...
### Controlando la investigación que se comparte

Como hemos visto anteriormente, diferentes tipos de propiedad intelectual se estipulan utilizando diferentes estructuras formales. Por ejemplo, los productos tales como textos y medios de comunicación se publican bajo copyright y el software se suministra bajo una licencia.

Es importante consultar con comunidades especializadas cuando se prepare su plan de investigación. Los métodos para compartir resultados pueden seguir diferentes estándares/prácticas o pueden requerir un formato de datos especial para su distribución o envío a repositorios comunes.
...
<table>
  ...
  <tbody>
    <tr>
        <td colspan="3">
            <ul>
            <li>GUÍA DE ELEMENTOS PARA SELECCIONAR ENTRE OPCIONES.</li>
            <li>Muchas versiones disponibles.</li>
            </ul>
        </td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
        <td colspan="3">
            <ul>
            <li>Opciones generales y específicas de disciplina.</li>
            <li>Verifica los requisitos de envío con antelación.</li>
            <li>A menudo tiene comunidades de usuarios dispuestas a ayudar.</li>
            </ul>
        </td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
        <td colspan="3">
            ...
            <li>Tome precauciones para reducir riesgos de seguridad.</li>
            </ul>
        </td>
    </tr>
  </tbody>
...
1. ¿Qué dice su supervisor o investigador principal?
...
Las universidades y otras instituciones pueden contar con oficinas de política de código abierto (OSPO, por sus siglas en inglés) u oficinas de comercialización. La mayoría de los institutos contarán con consejos asesores en propiedad intelectual para ayudar a responder preguntas. Los bibliotecarios son otro buen recurso para consultar a la hora de buscar consejos para compartir. Teniendo en cuenta estas políticas antes en su investigación puede ahorrar tiempo y energía en el camino, por todo esto...
...
Crédito de la imagen: [Library of Congress](https://commons.wikimedia.org/wiki/File:Library_of_Congress,_Rosenwald_4,_Bl._5r_cropped.jpg), Rosenwald. CC-BY

---

Además de documentar tu propia investigación, dar crédito a todos los colaboradores fortalece las prácticas y a la comunidad de la Ciencia Abierta. A medida que los investigadores adquieran confianza en los beneficios de la investigación cooperativa, reconocerán a su vez a colaboradores que de otro modo podrían haber pasado desapercibidos.

### Otras Razones Para No Compartir

Esta lección sólo ha cubierto escenarios comunes de cuándo y cómo compartir la ciencia. Sea cual sea la situación, es importante considerar las implicaciones de compartir información y aquellos que podrían verse afectados negativamente antes de decidir si la información debe ser compartida o cómo.

Para practicar una ciencia abierta responsable, se debe prestar especial atención a cómo se mantiene el anonimato en los datos y cómo se elimina otra la información sensible de estos, con el fin de proteger la identidad de las personas y prevenir violaciones de privacidad. El uso indebido de datos privados y su obtención por medios ilícitos de recolección son problemas que afectan a todos los sectores, no solo a la ciencia.
...
- Situaciones cuando puede ser inapropiado o perjudicial compartir sus datos o investigación. Estas incluyen el mantenimiento de la seguridad, la protección de la intimidad y el respeto de comunidades diversas.
- Qué propiedad intelectual es, quién la posee, y cómo se protege a través de licencias.
...
¿Qué tipo de protección de Propiedad Intelectual necesitaría para una imagen generada a partir de sus propios datos para mostrar sus resultados?
