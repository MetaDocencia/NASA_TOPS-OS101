...
- [Manteniendo la seguridad y protegiendo la privacidad](#manteniendo la seguridad-y-protegiendo la privacidad)
...
Ve este ejemplo y otros en [Open Science Data Repository](https://osdr.nasa.gov/bio/repo/data/studies/OSD-530/) de la NASA.
...
La justicia ambiental es el trato justo y la participación real de todas las personas, independientemente de su origen, nacionalidad o ingresos, en el desarrollo, aplicación y cumplimiento de las leyes, normativas y políticas ambientales. Más información sobre cómo [los datos de la NASA sobre la Tierra se hacen más accesibles a las comunidades más afectadas](https://www.earthdata.nasa.gov/learn/backgrounders/environmental-justice).
...
Si envías tu manuscrito a una editorial que requiere ser la dueña de los derechos de la obra, ¿Podrás acceder a esa publicación cuando cambies de trabajo y ya no tengas una suscripción a esa obra? ¿Puedes cumplir los mandatos de tu organismo de financiación para compartir abiertamente tu trabajo? ¿Puede reutilizar las figuras que has hecho en obras derivadas? ¿Podrán otros acceder a tu trabajo? Aunque parezcan cuestiones por las que no deberías preocuparte, puede resultar muy difícil afrontarlas luego.
...
### Preparándose para usar y hacer investigación controlada
...
<table>
  ...
  <tbody>
    <tr>
        <td colspan="3">
            <ul>
            <li>No asumas que la recolección está permitida sólo porque una ubicación de muestreo parece no administrada.</li>
...
### Compartiendo la investigación controlada
...
- Es de esperar que otros actúen de manera recíproca al utilizar tu trabajo. (la ética científica dicta que deberían hacerlo).
...
Esta lección sólo ha cubierto escenarios comunes de cuándo y cómo compartir la ciencia. Sea cual sea la situación, es importante considerar las implicancias de compartir información y a aquellos que podrían verse afectados negativamente antes de decidir si la información debe ser compartida o cómo.

Para practicar una ciencia abierta responsable, se debe prestar especial atención a cómo se mantiene el anonimato en los datos y cómo se elimina la información sensible de estos, con el fin de proteger la identidad de las personas y prevenir violaciones de privacidad. El uso indebido de datos privados y su obtención por medios ilícitos de recolección son problemas que afectan a todos los sectores, no solo a la ciencia.
