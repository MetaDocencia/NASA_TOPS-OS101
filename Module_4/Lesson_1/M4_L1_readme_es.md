...
| Mi código será usado, pero no citado                                                             | Aunque no es común que la comunidad de investigadores citen código, datos u otros artículos no publicados, la ética científica dicta que se debe citar si se utiliza su trabajo. Remember to appropriately cite the material of others so that you're not adding to the problem.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
